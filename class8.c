...
do{
 ...
 else if(c<1, c>4){ printf("You've entered the wrong choice!");
 ...
 printf ("Would you like to run the program again?\n\n[1].YES\n\n[2].NO\n\n");
  ...
  if(re==2){ printf("Thank you for using the program!");

  } 


   else if(re == 3){printf("Wrong command!!\n\nPlease restart the program!!\n\n");
